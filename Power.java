...
public class Power extends JFrame {
	...
	private JTextField textExpoenent;
	...
	public Power() {
		...
		textExpoenent = new JTextField();
		textExpoenent.setColumns(10);
		textExpoenent.setBounds(180, 97, 86, 20);
		contentPane.add(textExpoenent);
